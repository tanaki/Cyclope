...
:: Android packaging
set AND_CERT_NAME="Cyclope"
set AND_CERT_PASS=giants-cyclope
set AND_CERT_FILE=cert\Cyclope.p12
...
set IOS_PROVISION=cert\Cyclope.mobileprovision
...
set APP_ID=air.com.thegiants.cyclope.game.Cyclope

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Cyclope
